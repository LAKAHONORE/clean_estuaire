<head>
  ...
  <title>Adim - Clean Estuaire</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <link href="{{URL::asset('assets/img/logo-estuaire.png')}}" rel="icon">
  <link href="{{URL::asset('assets/img/logo-estuaire.png')}}" rel="apple-touch-icon">
