    ...
    <>
      ...
      >
        <NavLink to="/" className="flex flex-row justify-center items-center gap-2">
          <img src="/assets/logo_clean_estuaire.png" alt="logo" className="w-12" />
          <span className="lugrasimo-font font-bold">Clean Estuaire</span>
        </NavLink>
        ...
        <ul className="hidden md:flex flex-row justify-center items-center gap-8">
          ...
          <li className="">
            <NavLink to={`${data?.config.boutique_link}`} target="_blank" className="font-semibold text-white bg-blue px-4 py-3 hover:bg-purple transition-all rounded-md">
              Passer une commande
            </NavLink>
          </li>
